...
# 1 The historical context of GUI development in Java
...
## 1.1 AWT: The Platform-Native Approach (1995)
...
## 1.2 Swing: The Pure-Java Approach (1997)
...
## 1.3 JavaFX: The Modern Approach (2008/2014)
...
# 2 Event-driven programming and the callback model
...
JavaFX naturally supports the Model-View-Controller architecture:
...
# 3 Example: A simple GUI application using JavaFX and Scene Builder
...
## 3.3 Adding Accessibility Labels
