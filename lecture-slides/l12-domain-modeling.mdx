...
Previously, we learned to gather and analyze requirements:
</p>
...
<ul style={{fontSize: '0.78em'}}>
  <li><strong>Domain modeling</strong> transforms requirements into code structure</li>
  ...
  <li><strong>Responsibility heuristics</strong> apply Information Expert and cohesion</li>
