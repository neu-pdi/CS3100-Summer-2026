...
- Like AI lecture (AI coding assistants): **tools change, responsibility doesn’t**
...
<p style={{ fontSize: '0.95em' }}>
  The failure mode looks just like “vibe coding” (AI lecture), but for tests:
</p>
...
<aside class='notes'>
  **AI lecture connection:** evaluating “it runs” is not enough.\n \n **Testing equivalent:** evaluating
...
<aside class='notes'>
  **AI lecture workflow applied to Mockito:** Identify → Engage → Evaluate → Calibrate → Tweak →
...
**AI makes this easier to fall into (AI lecture):**
...
<p style={{ marginTop: '1em', fontSize: '0.85em', color: '#c60' }}>
  Key rule (AI lecture): only ask AI to produce what you can evaluate.
</p>
...
<p style={{ marginTop: '1em', fontSize: '0.85em', color: '#666' }}>
  If you can’t answer these, you’re in the “low familiarity” danger zone (AI lecture): you can’t evaluate
  the output.
</p>
...
- AI lecture AI: evaluation is the step that never changes
