...
- **Prerequisites:** readability (naming, code clarity), AI lecture AI coding assistants (workflow)
- **Connects to:** All future assignments (debugging is constant), final project

**Key connections to prior lectures:**
- **Readability:** Good names and clear code make program understanding MUCH easier
- **AI lecture AI Assistants:** The 6-step workflow applies directly to debugging with AI
...
```java
// CookbookImpl constructor (used by Jackson for JSON deserialization)
@JsonCreator
...
<aside className="notes">
**This is code from an assignment!** Understanding this data flow helps debug serialization issues.
...
```java
// UserLibraryImpl.findRecipesByTitle() - YOU must implement this!
...
<p style={{fontSize: '0.9em'}}>
When you see <code>collection.addRecipe(recipe)</code>, which <code>addRecipe</code> runs?
</p>
...
JSON serialization involves many method calls under the hood. Understanding this call graph helps debug serialization issues.
</p>
...
→ **Transition:** This should sound familiar from AI lecture...
</aside>
...
From <strong>AI lecture</strong>, we learned a 6-step workflow for AI collaboration. That same framework applies to debugging—AI can assist at <strong>each step</strong> of the scientific method, but YOU lead:
</p>
...
<aside className="notes">
**The integration:**
- This lecture's scientific method + AI lecture's AI workflow
...
→ **Transition:** But remember from AI lecture—some evaluations are harder than others...
</aside>
...
<p style={{fontSize: '0.85em'}}>
From <strong>AI lecture</strong>: AI can generate for any task, but evaluation difficulty varies:
</p>
...
<aside className="notes">
**From AI lecture - evaluation difficulty:**
...
→ **Transition:** And just like AI lecture warned about "vibe coding", we have "vibe debugging"...
</aside>
...
<ol style={{fontSize: '0.75em'}}>
  ...
  <li><strong>Scientific method</strong> — observe, hypothesize, predict, test, analyze, iterate (same as AI lecture's 6-step workflow!)</li>
...
<strong>From AI lecture:</strong> Task familiarity determines AI appropriateness. If you can't evaluate whether a bug fix is correct, you shouldn't accept AI's suggestion blindly.
</p>
...
- Practice the prompting techniques from AI lecture and today
...
- Practice the 6-step workflow from AI lecture
