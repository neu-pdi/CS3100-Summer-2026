...
- **Prerequisites:** (monoliths, modular monoliths, architectural styles), (distributed systems, eight fallacies, REST, security)
- **Connects to:** (teams and collaboration), L31-33 (concurrency, event architecture)

**Structure:**
- **Warm-up: Image Resize Example** (~8 min) — concrete feature → server code → infrastructure iceberg
- Recap: From Distributed to Serverless (~3 min) — connects previous two lectures arc
